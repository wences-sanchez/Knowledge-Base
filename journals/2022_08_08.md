...
- Para instalar cosas con el *user data* de **AWS**, hay que poner `-y` en todas las instrucciones que toquen #spaced #AWS
- Si hace falta abrir algún puerto, hay que abrirlo **siempre** en el grupo de seguridad de **AWS** #spaced #AWS
-
-
-