...
- Highlights first synced by [[Readwise]] [[Monday, 31-10-2022]]
	...
	- el código de salida de la orden anterior se almacena en el parámetro de shell $?. Este parámetro se utiliza para comprobar el estado de la última orden ejecutada.
	  ...
	  El valor concreto depende de cada utilidad, pero, en todo caso, es un número entero de 8 bits. #flashcard
		- ¿Qué significa el operador $? en bash?
		- (Page 8)
	- -
	- -
	- ls –aR: lista de forma recursiva. #flashcard
		- ¿Cómo puedes mostrar $tree de otra forma, sin usar ese comando?
		- (Page 10)
	- -
	- -
	- • zip arch.zip /home/usr/public/dir: comprime el directorio y su contenido en el fichero arch.zip.
	  ...
	  • tar xvzf package.tgz: descomprime el fichero package.tgz. #flashcard
		- ¿Cómo (des)comprimirías un .zip (o un .tar.gz) en shell?
		- (Page 10)
	- -
	- -
	- •  cp  -a  /home/usr/origen/*  /home/usr/destino/: copia todos los contenidos de un directorio a otro, manteniendo sus permisos. #flashcard
		- ¿Cómo copiarías un directorio a otro manteniendo sus permisos?
		- (Page 11)
	- -
	- -
	- • du -sh: visualiza el espacio total ocupado por la carpeta actual.
	  
	  • du -sh *: muestra el espacio ocupado de cada fichero. #flashcard
		- ¿Cómo consultarías el espacio ocupado por la carpeta actual?, ¿y por cada fichero?
		- (Page 11)
	- -
	- -
	- **$ whoami**; muestra el nombre del usuario. #flashcard
		- ¿Cómo podrías obtener el nombre del usuario actual en la shell?
		- (Page 11)
	- -
	- -
	...
	- El  fichero  sudoers  contiene  los permisos asignados a los usuarios y grupos del sistema. Debe editarse con  visudo: este comando abre el fichero  sudores con el editor del sistema (por ejemplo,  vi o nano) y lo valida al guardarlo. De esta manera, se evita que un usuario cometa un error de sintaxis al guardarlo, rompiendo la funcionalidad de Sudo. #flashcard
		- ¿Con qué comando debe abrirse el fichero sudoers?
		- (Page 15)
	- -
	- -
	- **$ export CONFIG_FILE=/opt/app/config** #flashcard
		- ¿Con qué comando puedes crear o cambiar variables de entorno en bash?
		- (Page 16)
	- -
	- -
	- **$ cat << HEREDOC**
	  ...
	  **HEREDOC** #flashcard
		- ¿Cómo ejecutarías un mensaje de varias líneas en bash?
		- (Page 17)
	- -
	- -
	- El comando test evalúa una condición lógica y devuelve un código de salida cero, si la  condición  es  verdadera,  o  distinto  de  cero,  si  es  falsa.  Este  comando  tiene  una forma  alternativa,  en  la  que  el  nombre  test  se  sustituye  por  corchetes,  [  ],  y  otra forma que usa corchetes dobles, [[ ]]; esta segunda forma no aplica expansión de ruta ni  división  de  palabras. #flashcard
		- ¿Qué códigos de salida devuelve una condición verdadera?¿Qué comando puedes usar para evaluarla?
		- (Page 18)
	- -
	- -
	- $ for r in i{1..3}; echo interacion $r do done #flashcard
		- ¿Cómo harías un bucle for en bash?
		- (Page 22)
	- -
	- -
	- for p in $@; do echo $p; done #flashcard
		- ¿Cómo puedes recorrer en Bash la lista de parámetros pasados como argumentos en el script con un bucle y mostrarlos?
		- (Page 22)
	- -
	- -
	...
	- -
	- **#!/bin/bash**
	  Deben empezar con un shebang, #!, en la primera línea, indicando la ruta al ejecutable de la shell. Esta línea es un comentario especial que permite ejecutar un script como un ejecutable binario más. Para un script de Bash, la línea sería #!/bin/bash, mientras que un script de Python podría usar #!/usr/bin/python3 v. #flashcard
		- ¿Cuál sería el shebang correcto para un script en Bash?
		- (Page 24)
	- -
	- -
	-   El uso de  exit indica explícitamente cuando termina el  script, tanto de manera correcta con un código de salida 0 como si hay algún error. #flashcard
		- ¿Qué valor debería devolver un script al terminar?
		- (Page 24)
	- -
	- -
