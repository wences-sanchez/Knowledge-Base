...
- Highlights first synced by [[Readwise]] [[Monday, 31-10-2022]]
	...
	- -
	- -
	-   Clase|activar/desactivar|permiso.   Representación binaria. #flashcard
		- ¿Cuál es el patrón de sintaxis de chmod?
		- (Page 10)
	- -
	- -
	...
	- -
	- -
	- Los  enlaces  se  crean  con  el  comando  ln.  Los  enlaces  serán  fuertes  por  defecto  y simbólicos con el flag -s. La manera más sencilla de crear un enlace simbólico en la ruta actual es simplemente indicando la ruta del archivo enlazado #flashcard
		- ¿Cómo se puede crear un enlace simbólico?
		- (Page 12)
	- -
	- -
