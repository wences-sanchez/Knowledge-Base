...
- Highlights first synced by [[Readwise]] [[Monday, 31-10-2022]]
	...
	- -
	- -
	- Cada dominio tiene una estructura de  árbol de contenedores. Estos contenedores pueden ser carpetas normales o unidades organizativas. La Figura 9 muestra el árbol de carpetas de un dominio y el contenido de una de las carpetas. #flashcard
		- ¿Cómo se organizan en árboles el Directorio Activo?
		- (Page 16)
	- -
	- -
