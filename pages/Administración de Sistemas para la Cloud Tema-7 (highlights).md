...
- Highlights first synced by [[Readwise]] [[Thursday, 18-08-2022]]
	- -
	- ¿En qué tipo de flujo está basada PowerShell? #card
	...
	- -
	- -
	- ¿Qué hace el comando Get-Member? #card
	...
	- -
	- -
	- ¿Cómo podrías acceder a un item dentro de un bucle en PowerShell? #card
	...
	- -
	- -
	- ¿Cómo puedes obtener información de las unidades de almacenamiento disponibles en PowerShell? #card
	...
	- -
	- -
	- Algunos ejemplos de alias en PowerShell. #card
	...
	- -
	- -
	- ¿Cómo usarías, exportarías e importarías alias en PowerShell? #card
	...
	- -
	- -
	- ¿Qué extensión tienen los scripts de PowerShell? #card
	...
	- -
	- -
	- ¿Cuáles son las políticas de ejecución, de medidas de seguridad, posibles en PowerShell? #card
	...
	- -
	- -
	- ¿Cómo se especifican los comentarios en PowerShell? #card
	...
	- -
	- -
	- Manera de llamar a un script sin sobreescribir variables en PowerShell. #card
	...
	- -
	- -
	- ¿Cómo podrías ejecutar un script en PowerShell de manera que tenga el mismo efecto que llamar a todos sus comandos en la CLI? #card
	...
	- -
	- -
	- Ejemplo de documentación de función en PowerShell #card
	...
	- -
	- -
	- Ejemplo de uso de ForEach en una tubería. #card
		- Get-ChildItem -Path C:\Users\Administrator -File | ForEach { Write-Host $_.Name }
		- (Page 22)
	- -
	- -
	- ¿Cómo ordenarías los contenidos de una carpeta por extensión y tamaño de manera descendente? .code #card
		- PS  C:\>  Get-ChildItem  -Path  C:\Users\Administrator  -File  | Sort-Object  Property Extension,Length -Descending
		- (Page 22)
	- -
	- -
	- Ejemplo de para qué sirve el comando Where-Object. #card
	...
	- -
	- -
	- ¿Cómo usarías el comando Select-Object en PowerShell? #card
