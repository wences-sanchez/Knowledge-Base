...
- Highlights first synced by [[Readwise]] [[Thursday, 18-08-2022]]
	- -
	- ¿En qué tipo de flujo está basada PowerShell? #car
	  id:: 634014ef-d854-4bca-9aaf-de3913e97d1a
	...
	- -
	- -
	- ¿Qué hace el comando Get-Member? #car
	  id:: 634014ef-aa53-4eb0-9527-eb8c35a2ab45
	...
	- -
	- -
	- ¿Cómo podrías acceder a un item dentro de un bucle en PowerShell? #car
	  id:: 634014ef-777a-482b-9729-777ba42f73c2
	...
	- -
	- -
	- ¿Cómo puedes obtener información de las unidades de almacenamiento disponibles en PowerShell? #car
	...
	- -
	- -
	- Algunos ejemplos de alias en PowerShell. #car
	  id:: 634014ef-a9a4-40d4-8778-23cd18d0eeb3
	...
	- -
	- -
	- ¿Cómo usarías, exportarías e importarías alias en PowerShell? #car
	  id:: 634014ef-8ef8-4432-adae-26acfcdabd98
	...
	- -
	- -
	- ¿Qué extensión tienen los scripts de PowerShell? #car
	...
	- -
	- CONTINÚA #car
	  id:: 634014ef-80bc-4ef4-b1b9-c0817d11f6ee
	...
	- -
	- -
	- ¿Cuáles son las políticas de ejecución, de medidas de seguridad, posibles en PowerShell? #car
	...
	- -
	- -
	- ¿Cómo se especifican los comentarios en PowerShell? #car
	  id:: 634014ef-3699-4059-9605-dfb26f75bb44
	...
	- -
	- -
	- Manera de llamar a un script sin sobreescribir variables en PowerShell. #car
	...
	- -
	- -
	- ¿Cómo podrías ejecutar un script en PowerShell de manera que tenga el mismo efecto que llamar a todos sus comandos en la CLI? #car
	  id:: 634014ef-268b-48bc-9c2a-22e1c4eadce3
	...
	- -
	- -
	- Ejemplo de documentación de función en PowerShell #car
	...
	- -
	- -
	- Ejemplo de IfElse en PowerShell #car
	  id:: 634014ef-f45b-4591-bda5-b6057ffd265d
		- } If ($Var1 -eq $Var2) { Write-Host "Iguales" } ElseIf ($Var1 -gt $Var2) { Write-Host "Mayor" } Else { Write-Host "Menor"
		- (Page 20)
	- -
	- -
	- Ejemplo de ForEach en PowerShell #car
	  id:: 634014ef-3aca-4d96-9754-938e3649e9dd
	...
	- -
	- -
	- Ejemplo de uso de ForEach en una tubería. #car
	  id:: 634014ef-d988-49aa-992e-a561bf8b9db3
		- Get-ChildItem -Path C:\Users\Administrator -File | ForEach { Write-Host $_.Name }
		- (Page 22)
	- -
	- -
	- ¿Cómo ordenarías los contenidos de una carpeta por extensión y tamaño de manera descendente? .code #car
		- PS  C:\>  Get-ChildItem  -Path  C:\Users\Administrator  -File  | Sort-Object  Property Extension,Length -Descending
		- (Page 22)
	- -
	- -
	- Ejemplo de para qué sirve el comando Where-Object. #car
	...
	- -
	- -
	- ¿Cómo usarías el comando Select-Object en PowerShell? #car
	  id:: 634014ef-2347-4972-b0fb-6c63e5a6e5d3
