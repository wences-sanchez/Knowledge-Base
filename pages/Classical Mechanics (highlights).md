...
- Highlights first synced by [[Readwise]] [[Monday, 31-10-2022]]
	- Lecture 1: The Nature of Classical Physics
		...
		- RULES THAT ARE NOT ALLOWED: THE MINUS-FIRST LAW
			...
			- -
			- -
			- The meaning of reversible—in the context of physics—can be described a few different ways. The most concise description is to say that if you reverse all the arrows, the resulting law is still deterministic. Another way, is to say the laws are deterministic into the past as well as the future. #flashcard
				- It is no possible for a graph to have more than one input and one output for every single vertex.
			...
			- -
			- -
			- The conservation of information is simply the rule that every state has one arrow in and one arrow out. It ensures that you never lose track of where you started. #flashcard
				- It's simply a memory from where we started. Something with doesn't change with time.
			...
			- -
			- -
			- Instead we use the radian; we say that there are 2 radians in 360°, or 1 radian = /180°, thus 90° = /2 radians, and 30° = /6 radians. Thus a radian is about 57° #flashcard
				- What is a radian?
				- tags:: [[learn]]
				- ([Location 428](https://readwise.io/to_kindle?action=open&asin=B084D4ZC17&location=428))
			- -
			- -
			- If an object is moved from some particular starting location, it is not enough to know how far it is moved in order to know where it winds up. One also has to know the direction of the displacement. Displacement is the simplest example of a vector quantity. #flashcard
				- What is needed for a vector?
				- tags:: [[learn]]
