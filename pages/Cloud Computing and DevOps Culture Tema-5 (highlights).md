...
- Highlights first synced by [[Readwise]] [[Thursday, 18-08-2022]]
	- -
	- El primer caso de uso de la virtualización suele ser la consolidación de servidores. Esta se refiere a tomar instancias separadas del servidor y migrarlas a máquinas virtuales que se ejecutan en un único servidor. Pero además de ello, la consolidación de #card
	...
	- -
	- -
	- Acerca de la virtualización en la nube privada #card
	...
	- -
	- -
	- ¿Cómo funciona la alta disponiblidad? #card
	...
	- -
	- -
	- Acerca de la réplica de datos #card
	...
	- -
	- -
	- Acerca de un pool de servidores virtualizados #card
	...
	- -
	- -
	- Sobre las cosas 'cool' en el trabajo #card
