...
- Highlights first synced by [[Readwise]] [[Thursday, 18-08-2022]]
	...
	- -
	- -
	- ¿Qué es una *imágen* en Docker? #card
	...
	- -
	- -
	- ¿Cómo construirías una imágen de Docker a través de la línea de comandos? #card
	...
	- -
	- -
	- ¿Cómo podrías guardar el estado actual de un contendor en *Docker* a través de la línea de comandos? #card
	...
	- -
	- -
	- ¿Cómo podrías nombrar (o etiquetar) una *imagen* en Docker? #card
	...
	- -
	- -
	- ¿Cómo puedes mostrar las imágenes que hay, en Docker? #card
		- $ docker images nginx REPOSITORY     TAGIMAGE ID       CREATED        SIZE nginx          alpine7d0cdcc60a96   4 weeks ago    21.3MB
		- (Page 13)
	- -
	- -
	- ¿Con qué comando borrarías una *imagen* en Docker? #card
		- $ docker rmi nginx:alpine Untagged: nginx:alpine
		- (Page 13)
	- -
	- -
	- ¿Cómo podemos eliminar las imágenes en Docker que *estén en desuso*? #card
	...
	- -
	- -
	- ¿Cómo podemos listar las imágenes de Docker *en desuso*? #card
	...
	- -
	- -
	- ¿Cómo podemos ver las diferentes capas de una *imagen* en **Docker**? #card
	...
	- -
	- -
	- Explica las etapas en los **Dockerfile**. #card
