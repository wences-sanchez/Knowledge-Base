...
- Highlights first synced by [[Readwise]] [[Thursday, 18-08-2022]]
	...
	- -
	- <<<<<<<<<< #car
	  id:: 634014ff-3bd8-444b-941f-8518aa7f20c5
	...
	- -
	- -
	- ¿Cómo puedo ejecutar un contenedor *Docker*? #car
	  id:: 634014ff-0a16-4f8c-a35b-6aa9016a8853
	...
	- -
	- -
	- ¿Cómo puedo hacer para que un contenedor se ejecute, pero en segundo plano? #car
	...
	- -
	- -
	- ¿Cómo puedo hacer que un contenedor se ejecute, pero pudiendo interactuar con él y con su terminal también? #car
	  id:: 634014ff-e04e-4543-b951-5ccd5e6769da
	...
	- -
	- -
	- ¿Cómo podemos parar *manualmente* la ejecución de un contenedor? #car
	...
	- -
	- -
	- ¿Cómo podemos acceder al terminal de un contenededor *Docker* en ejecución? #car
	  id:: 634014ff-5c6c-41c4-a2c7-efe72556fc3c
	...
	- -
	- -
	- ¿Cómo podemos acceder a los logs de un contenedor *Docker*? #car
	...
	- -
	- -
	- ¿Cuáles son las cuatro *políticas de reinicio* disponibles en **Docker**? #car
	  id:: 634014ff-b364-44bf-a18f-a23b52c37367
	...
	- -
	- -
	- Maneras de montar un volume a Docker mediante la CLI. #car
	...
	- -
	- <<<<<<< #car
	  id:: 634014ff-9a79-406e-87a8-707a28d475c3
	...
	- -
	- -
	- ¿Cómo funcionan los *bind mounts* en **Docker**? #car
	...
	- -
	- -
	- Explica en qué consisten los *tmpfs mounts* en Docker. #car
	  id:: 634014ff-a02b-409a-8d05-4bbc83e066b0
	...
	- -
	- <<<<<<<<< #car
	  id:: 634014ff-bf7a-4006-9a6c-f2b710b1b87d
	...
	- -
	- AÑADIR IMAGEN #car
	  id:: 634014ff-698c-40a7-aeed-fd4b91d26326
		- Tabla 2. Comandos para la gestión de redes.
		- (Page 25)
	- -
	- -
	- Controladores de red para Docker: #car
