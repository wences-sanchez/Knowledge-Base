...
- Highlights first synced by [[Readwise]] [[Thursday, 18-08-2022]]
	...
	- -
	- -
	- ¿Cómo puedo ejecutar un contenedor *Docker*? #card
	...
	- -
	- -
	- ¿Cómo puedo hacer para que un contenedor se ejecute, pero en segundo plano? #card
	...
	- -
	- -
	- ¿Cómo puedo hacer que un contenedor se ejecute, pero pudiendo interactuar con él y con su terminal también? #card
	...
	- -
	- -
	- ¿Cómo podemos parar *manualmente* la ejecución de un contenedor? #card
	...
	- -
	- -
	- ¿Cómo podemos acceder al terminal de un contenededor *Docker* en ejecución? #card
	...
	- -
	- -
	- ¿Cómo podemos acceder a los logs de un contenedor *Docker*? #card
	...
	- -
	- -
	- ¿Cuáles son las cuatro *políticas de reinicio* disponibles en **Docker**? #card
	...
	- -
	- -
	- Maneras de montar un volume a Docker mediante la CLI. #card
	...
	- -
	- -
	- ¿Cómo funcionan los *bind mounts* en **Docker**? #card
	...
	- -
	- -
	- Explica en qué consisten los *tmpfs mounts* en Docker. #card
	...
	- -
	- -
	- Controladores de red para Docker: #card
