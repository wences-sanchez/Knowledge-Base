...
- Highlights first synced by [[Readwise]] [[Thursday, 18-08-2022]]
	...
	- -
	- -
	- Diferencias entre Docker Swarm y Kubernetes #card
	...
	- -
	- -
	- ¿Qué es un servicio en Kubernetes? #card
	...
	- -
	- -
	- Define el componente API Server de un nodo Master en Kubernetes #card
	...
	- -
	- -
	- Explica qué hace el componente Scheduler de un nodo Master en Kubernetes #card
	...
	- -
	- -
	- ¿De qué e encarga el componente ***Controller Manager*** en un _nodo Mater_ de _Kubernete_? #card
		- s
		- (Page 10)
	- -
	- -
	- Enumera los cuatro controladores que incluye el componente **Controller Manager** de un _nodo master_ en Kubernetes #card
	...
	- -
	- INCLUIR IMÁGEN!!
	  Define, básicamente, qué es un _nodo worker_ en Kubernetes. #card
	...
	- -
	- -
	- ¿Para qué sirve el componente **kubelet** dentro de un *nodo worker* en *Kubernetes* ? #card
	...
	- -
	- -
	- ¿Cuál es la función de **kube-proxy** en los *nodos worker* de *Kubernetes* ? #card
	...
	- -
	- -
	- ¿Para qué sirven los namespaces en Kubernetes? #card
	...
	- -
	- -
	- Define PersistentVolume en Kubernetes. #card
	...
	- -
	- -
	- Acerca de los **ConfigMaps** y **Secrets** en *Kubernetes* #card
	...
	- -
	- -
	- Explica qué hace el controlador **Deployment** de Kubernetes. #card
	...
	- -
	- -
	- Define ReplicaSet en Kubernetes. #card
	...
	- -
	- -
	- ¿Qué es y para qué sirve el controlador **StatefulSets** de Kubernetes? #card
