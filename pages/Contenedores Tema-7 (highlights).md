...
- Highlights first synced by [[Readwise]] [[Thursday, 18-08-2022]]
	...
	- -
	- AÑADIR IMAGEN #car
	  id:: 63401500-c840-4cde-a317-50e278c9d4e2
	...
	- ¿Cómo podrías establecer un túnel entre la máquina local u una instancia de un pod en Kubernetes?
	  id:: 63401500-af2a-406c-9ee9-7f58f6b342b7
	...
	- -
	- -
	- ¿Cómo ejecutarías un comando custom en un pod de Kubernetes? #car
	  id:: 63401500-75cf-466c-8c66-c8e35cf65232
	...
	- -
	- -
	- Ejemplos de copia de ficheros de *pods* en Kubernetes #car
		- $ kubectl cp mypod:/data/app.dump ./app.dump $ kubectl cp $HOME/config.txt mypod:/config.txt
		- (Page 13)
	- -
	- -
	- ¿Cuáles son las secciones más importantes que se usarán en la mayoría de los objetos de Kubernetes? #car
	...
	- -
	- -
	- Ejemplo sencillo de *pod* en Kubernetes #car
	...
	- -
	- -
	- ¿Cómo se podrían implementar los *checks* **livenessProbe** y **readinessProbe** en Kubernetes? #car
	  id:: 63401500-b8c8-4bd0-9131-a9d854e12eb1
	...
	- -
	- -
	- ¿Qué checks hay disponibles en Kubernetes, además de las *liveness probe*?` #car
	...
	- -
	- -
	- Ejemplo de definición de recursos a un pod en YAML #car
	...
	- ¿Cómo puedes mostrar las etiquetas de un objeto en Kubernetes?
	  ¿Y las adicionales que queramos? #car
	...
	- -
	- -
	- ¿Qué **namespaces** por defecto tiene Kubernetes? #car
	...
	- -
	- <<<<<<< #car
	  id:: 63401500-dbc9-4df8-8bd2-610893ebdf08
		- kube-node-lease   Active   12d kube-public       Active   12d kube-system       Active   12d
		- (Page 26)
	- -
	- -
	- Comandos para listar y crear **namespaces** en *Kubernetes* #car
	  id:: 63401500-d493-4619-b2b8-4c0de69d2ccd
	...
	- ¿De qué elementos están formados los contextos en Kubernetes?
	  id:: 63401500-088f-471f-899a-9b033b7ca444
	...
	- -
	- -
	- ¿Cómo podemos establecer un contexto como el actual en Kubernetes? #car
	  id:: 63401500-152d-49a4-9cec-e8f6847879aa
