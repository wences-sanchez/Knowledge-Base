title:: DevOps on AWS - AWS Technical Essentials (highlights)
author:: [[coursera.org]]
...
- Highlights first synced by [[Readwise]] [[Friday, 28-10-2022]]
	...
	- Don't always assume that VMs are the default and correct answer. Sometimes it makes sense to architect applications for serverless compute or containers from the start, depending on what you are building for and what you are optimizing for.
	...
	- how do you choose a region? By looking at compliance, latency, pricing, and service availability.