title:: Herramientas DevOps Tema-1 (highlights) (1)
author:: [[UNIR]]
...
- Highlights first synced by [[Readwise]] [[Friday, 07-10-2022]]
	...
	- Aunque las fases se traten linealmente en esta asignatura, estas no se implementarán en cascada. Una de las enseñanzas más importantes de DevOps es la necesidad de iterar e ir realizando pasos incrementales lo más frecuentes posibles.
	  ...
	  Esto nos llevará a hablar en todas las fases de cómo las diferentes herramientas pueden soportar esta iteración. #spaced
		- (Page 5)
	- -
	- -
	...
	- -
	- -
	- Azure  Resource  Manager  permite  desplegar  recursos  en  un  Resource  Group  de Azure. #spaced
		- (Page 13)
	- -
	- -
