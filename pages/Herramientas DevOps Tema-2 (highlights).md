...
- Highlights first synced by [[Readwise]] [[Thursday, 18-08-2022]]
	- -
	- ¿A qué nos referimos cuando hablamos de componente en DevOps? #car
	...
	- -
	- -
	- ¿Cuándo se dice que un componente guarda un estado? #car
	  id:: 63401514-9696-4e82-a738-352d3bd014a7
	...
	- -
	- -
	- ¿Qué caracteriza a un componente sin estado? #car
	  id:: 63401514-b48e-44a2-94e3-819af364fd5e
	...
	- -
	- -
	- ¿Cuándo puede (o no) un estado de un componente ser reconstruido? #car
	...
	- -
	- -
	- Un componente, ¿puede ser reusable? #car
	...
	- -
	- -
	- ¿Cuáles son los componentes que más frecuentemente cambian en las aplicaciones? #car
	...
	- -
	- -
	- ¿Cuáles son las principales necesidades de un componente de cómputo? #car
	  id:: 63401514-125d-47b3-b619-3309a19acfe1
	...
	- -
	- ¿Qué es el CaaS? #car
	  id:: 63401514-add7-4f64-98d2-ee2068ae247d
	...
	- -
	- -
	- Características de las FaaS: +++ #car
	  id:: 63401514-2a1c-4b33-9a78-9b1fb8b1fa8a
	...
	- -
	- -
	- Acrca d las Lambdas n l Cloud. #car
	  id:: 63401514-d401-411a-9e60-d2e8c1803d30
		- e
		- (Page 14)
	- -
	- -
	- ¿Cómo se pueden escalar las aplicaciones dependiendo de si tienen estado o no? #car
	...
	- -
	- -
	- Habla acerca del tipo de BBDD, referente al contenido y consulta, conocido como OLAP. #car
	...
	- -
	- -
	- Habla acerca del tipo de BBDD, referente al contenido y consulta, conocido como Data Warehouse. #car
	  id:: 63401514-5779-40e0-9a70-c148fba6a0fe
	...
	- -
	- -
	- Habla acerca del tipo de BBDD, referente a su interfaz exterior o paradigma, conocido como SQL. #car
	...
	- -
	- -
	- Habla acerca del tipo de BBDD, referente a su interfaz exterior o paradigma, conocido como orientadas a documentos. #car
	  id:: 63401514-2aaa-4b4c-b0cf-d51c255c68f3
	...
	- -
	- -
	- Habla acerca del tipo de BBDD, referente a su interfaz exterior o paradigma, conocido como orientadas a grafo. #car
	  id:: 63401514-2ce6-4c46-8c59-045dac5c75b6
	...
	- -
	- -
	- Habla acerca del tipo de BBDD, referente a su interfaz exterior o paradigma, conocido como orientadas a columna. #car
	...
	- -
	- -
	- Habla acerca del tipo de BBDD, referente a su interfaz exterior o paradigma, conocido como Backups. #car
	...
	- -
	- -
	- Habla acerca del tipo de BBDD, referente a su interfaz exterior o paradigma, conocido como migración de esquemas y datos. #car
	...
	- -
	- -
	- Habla acerca del tipo de BBDD, referente a su interfaz exterior o paradigma, conocido como Redundancia y alta disponibilidad. #car
	...
	- -
	- -
	- ¿Cómo funciona el concepto maestro-esclavo en bases de datos? #car
	...
	- -
	- -
	- Patrón de consumo de cola de mensajes conocido como Colas de trabajo: +++ #car
	...
	- -
	- -
	- Patrón de consumo de cola de mensajes conocido como Pub/Sub o publicación y suscripción #car
	  id:: 63401514-7250-43ae-be52-c2c864382581
	...
	- -
	- -
	- Patrón de consumo de cola de mensajes conocido como Enrutado sofisticado: +++ #car
	...
	- -
	- -
	- Patrón de consumo de cola de mensajes conocido como Llamada a un procedimiento remoto. #car
	...
	- -
	- -
	- ¿Qué son los motores de búsqueda? #car
	  id:: 63401514-70c8-466f-9bfb-5d8b9dfcf6e5
