...
- Highlights first synced by [[Readwise]] [[Thursday, 18-08-2022]]
	- -
	- ¿A qué nos referimos cuando hablamos de componente en DevOps? #card
	...
	- -
	- -
	- ¿Cuándo se dice que un componente guarda un estado? #card
	...
	- -
	- -
	- ¿Qué caracteriza a un componente sin estado? #card
	...
	- -
	- -
	- ¿Cuándo puede (o no) un estado de un componente ser reconstruido? #card
	...
	- -
	- -
	- Un componente, ¿puede ser reusable? #card
	...
	- -
	- -
	- ¿Cuáles son los componentes que más frecuentemente cambian en las aplicaciones? #card
	...
	- -
	- -
	- ¿Cuáles son las principales necesidades de un componente de cómputo? #card
	...
	- -
	- -
	- Características de las FaaS: +++ #card
	...
	- -
	- -
	- Acrca d las Lambdas n l Cloud. #card
		- e
		- (Page 14)
	- -
	- -
	- ¿Cómo se pueden escalar las aplicaciones dependiendo de si tienen estado o no? #card
	...
	- -
	- -
	- Habla acerca del tipo de BBDD, referente al contenido y consulta, conocido como OLAP. #card
	...
	- -
	- -
	- Habla acerca del tipo de BBDD, referente al contenido y consulta, conocido como Data Warehouse. #card
	...
	- -
	- -
	- Habla acerca del tipo de BBDD, referente a su interfaz exterior o paradigma, conocido como SQL. #card
	...
	- -
	- -
	- Habla acerca del tipo de BBDD, referente a su interfaz exterior o paradigma, conocido como orientadas a documentos. #card
	...
	- -
	- -
	- Habla acerca del tipo de BBDD, referente a su interfaz exterior o paradigma, conocido como orientadas a grafo. #card
	...
	- -
	- -
	- Habla acerca del tipo de BBDD, referente a su interfaz exterior o paradigma, conocido como orientadas a columna. #card
	...
	- -
	- -
	- Habla acerca del tipo de BBDD, referente a su interfaz exterior o paradigma, conocido como Backups. #card
	...
	- -
	- -
	- Habla acerca del tipo de BBDD, referente a su interfaz exterior o paradigma, conocido como migración de esquemas y datos. #card
	...
	- -
	- -
	- Habla acerca del tipo de BBDD, referente a su interfaz exterior o paradigma, conocido como Redundancia y alta disponibilidad. #card
	...
	- -
	- -
	- ¿Cómo funciona el concepto maestro-esclavo en bases de datos? #card
	...
	- -
	- -
	- Patrón de consumo de cola de mensajes conocido como Colas de trabajo: +++ #card
	...
	- -
	- -
	- Patrón de consumo de cola de mensajes conocido como Pub/Sub o publicación y suscripción #card
	...
	- -
	- -
	- Patrón de consumo de cola de mensajes conocido como Enrutado sofisticado: +++ #card
	...
	- -
	- -
	- Patrón de consumo de cola de mensajes conocido como Llamada a un procedimiento remoto. #card
	...
	- -
	- -
	- ¿Qué son los motores de búsqueda? #card
