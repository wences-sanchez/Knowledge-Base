...
- Highlights first synced by [[Readwise]] [[Thursday, 18-08-2022]]
	- -
	- ¿Qué se entiende como cliente ligero cuando hablamos de aplicaciones de cliente? #card
	...
	- -
	- -
	- ¿Qué se entiende como cliente pesado cuando hablamos de aplicaciones de cliente? #card
	...
	- -
	- -
	- ¿Cuándo decimos que un sistema software tiene una arquitectura monolítica? #card
	...
	- -
	- -
	- ¿Qué es una aplicación multicapa? +++ #card
	...
	- -
	- -
	- ¿Cuándo es posible aumentar la escalabilidad horizontal desplegando múltiples capas? #card
	...
	- -
	- -
	- Características más importantes de los microservicios: #card
	...
	- -
	- -
	- ¿Qué son las mallas de servicios? #card
	...
	- -
	- -
	- Componentes de malla de microservicios #card
	...
	- Componentes de malla de microservicios.
	  ...
	  parámetros de equilibrio de carga se pueden modificar a través de API, lo que hace posible orquestar implementaciones azul-verde o canarios3. #card
