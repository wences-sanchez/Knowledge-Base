...
- Highlights first synced by [[Readwise]] [[Thursday, 18-08-2022]]
	- -
	- ¿Qué se entiende como cliente ligero cuando hablamos de aplicaciones de cliente? #car
	...
	- -
	- -
	- ¿Qué se entiende como cliente pesado cuando hablamos de aplicaciones de cliente? #car
	  id:: 63401515-3dba-4bdc-9179-5f1447dacef6
	...
	- -
	- -
	- ¿Cuándo decimos que un sistema software tiene una arquitectura monolítica? #car
	  id:: 63401515-f232-4423-a589-3f123cd82f64
	...
	- -
	- -
	- ¿Qué es una aplicación multicapa? +++ #car
	  id:: 63401515-ffad-4a92-ad5c-940391b68da4
	...
	- -
	- -
	- ¿Cuándo es posible aumentar la escalabilidad horizontal desplegando múltiples capas? #car
	  id:: 63401515-3db1-42ec-90b4-7f2be85023bf
	...
	- -
	- -
	- Características más importantes de los microservicios: #car
	  id:: 63401515-350f-441d-b52a-5dce386154d1
	...
	- -
	- -
	- ¿Qué son las mallas de servicios? #car
	  id:: 63401515-ccbe-4890-8386-7cee99999d9a
	...
	- -
	- -
	- Componentes de malla de microservicios #car
	...
	- Componentes de malla de microservicios.
	  ...
	  parámetros de equilibrio de carga se pueden modificar a través de API, lo que hace posible orquestar implementaciones azul-verde o canarios3. #car
	...
	- -
	- Componentes de malla de microservicios. #car
	  id:: 63401515-21c6-4868-a5bd-c8f19bf5ecb1
