...
- Highlights first synced by [[Readwise]] [[Thursday, 18-08-2022]]
	- -
	- ¿Qué guardarías en ElasticSearch? #car
	...
	- -
	- -
	- ¿Qué es, básicamente, ElasticSearch? #car
	  id:: 63401515-d1c9-4323-b8fe-7751f1e5b244
	...
	- -
	- -
	- ¿Cómo funciona el concepto de índice invertido en ElasticSearch? #car
	...
	- -
	- -
	- Define índice y documento en ElasticSearch. #car
	...
	- -
	- -
	- Ejemplo de inserción de datos en ElasticSearch #car
	...
	- -
	- -
	- Ejemplo de recuperación de documento en ElasticSearch #car
	  id:: 63401515-e1dd-45c7-8a4b-e38d0d1bb76f
		- documento: GET /customer/_doc/1 Puedes  recuperarlo  con  una  solicitud  GET  que  especifique  su  ID  de
		- (Page 10)
	- -
	- -
	- Habla acerca de los índices congelados en ElasticSearch #car
	...
	- -
	- -
	- ¿Cómo congelarías un índice en ElasticSearch? #car
		- Es posible congelar un índice utilizando la API Freeze Index: POST /<index>/_freeze
		- (Page 12)
	- -
	- -
	- ¿Cómo descongelarías un índice en ElasticSearch? #car
	  id:: 63401515-815f-42ca-aede-c1fadd14fd9b
		- Para “descongelar” un índice, puedes usar la API de índice Unfreeze: POST /<index>/_unfreeze
		- (Page 13)
	- -
	- -
	- ¿Dónde y cómo guarda los datos ElasticSearch? #car
	...
	- -
	- -
	- Define Rollup en ElasticSearch. #car
	  id:: 63401515-7e63-4c4d-9f93-b6326db8328d
	...
	- -
	- -
	- ¿Cómo trabaja Rollup con los datos (procesados y sin procesar) en ElasticSearch? #car
	...
	- -
	- -
	- Ejemplo de búsqueda en ElasticSearch Query DSL #car
	...
	- -
	- -
	- Campos de respuesta a una consulta en ElasticSearch #car
	...
	- -
	- -
	- Ejemplo de consulta match sencilla en ElasticSearch #car
	  id:: 63401515-5d8a-4838-b856-cc14cfb28f83
	...
	- -
	- -
	- Ejemplo de consulta match de frase en ElasticSearch #car
	  id:: 63401515-824f-4ba6-9b68-34c026d5034b
		- GET /bank/_search Rioja" } } "query":  {  "match_phrase":  {  "address":  "Calle  de  la  Universidad  de  la { }
		- (Page 22)
	- -
	- -
	- ¿Cómo podrías construir consultas más complejas en ElasticSearch? #car
	  id:: 63401515-2a00-4f77-a9a3-e295cbc26d3b
	...
	- -
	- -
	- ¿Cómo buscarías en ElasticSearch personas que tengan 40 años y que no vivan en La Rioja? #car
	...
	- -
	- -
	- ¿Qué es, básicamente, una agregación en ElasticSearch? #car
	  id:: 63401515-d0fd-400c-b5d3-3593af2ac9c0
	...
	- -
	- -
	- Menciona los cuatro tipos de agregaciones en ElasticSearch. #car
	  id:: 63401515-6a90-4433-95a8-170d9d2a8075
	...
	- -
	- -
	- Sobre las agregaciones de tipo métricas en ElasticSearch. #car
	...
	- -
	- -
	- Acerca de las agregaciones de tipo de agrupación en ElasticSearch. #car
	  id:: 63401515-3391-4c91-8e82-3ace298503a2
	...
	- -
	- -
	- Acerca de las agregaciones de tipo de pipeline en ElasticSearch. #car
	  id:: 63401515-7e40-4c3c-a782-b8268f629f76
