...
- Highlights first synced by [[Readwise]] [[Thursday, 18-08-2022]]
	- -
	- ¿Qué guardarías en ElasticSearch? #card
	...
	- -
	- -
	- ¿Qué es, básicamente, ElasticSearch? #card
	...
	- -
	- -
	- ¿Cómo funciona el concepto de índice invertido en ElasticSearch? #card
	...
	- -
	- -
	- Define índice y documento en ElasticSearch. #card
	...
	- -
	- -
	- Ejemplo de inserción de datos en ElasticSearch #card
	...
	- -
	- -
	- Ejemplo de recuperación de documento en ElasticSearch #card
		- documento: GET /customer/_doc/1 Puedes  recuperarlo  con  una  solicitud  GET  que  especifique  su  ID  de
		- (Page 10)
	- -
	- -
	- Habla acerca de los índices congelados en ElasticSearch #card
	...
	- -
	- -
	- Define Rollup en ElasticSearch. #card
	...
	- -
	- -
	- ¿Cómo trabaja Rollup con los datos (procesados y sin procesar) en ElasticSearch? #card
	...
	- -
	- -
	- Ejemplo de búsqueda en ElasticSearch Query DSL #card
	...
	- -
	- -
	- Campos de respuesta a una consulta en ElasticSearch #card
	...
	- -
	- -
	- Ejemplo de consulta match sencilla en ElasticSearch #card
	...
	- -
	- -
	- Ejemplo de consulta match de frase en ElasticSearch #card
		- GET /bank/_search Rioja" } } "query":  {  "match_phrase":  {  "address":  "Calle  de  la  Universidad  de  la { }
		- (Page 22)
	- -
	- -
	- ¿Cómo podrías construir consultas más complejas en ElasticSearch? #card
	...
	- -
	- -
	- ¿Cómo buscarías en ElasticSearch personas que tengan 40 años y que no vivan en La Rioja? #card
	...
	- -
	- -
	- ¿Qué es, básicamente, una agregación en ElasticSearch? #card
	...
	- -
	- -
	- Menciona los cuatro tipos de agregaciones en ElasticSearch. #card
	...
	- -
	- -
	- Sobre las agregaciones de tipo métricas en ElasticSearch. #card
	...
	- -
	- -
	- Acerca de las agregaciones de tipo de agrupación en ElasticSearch. #card
	...
	- -
	- -
	- Acerca de las agregaciones de tipo de pipeline en ElasticSearch. #card
