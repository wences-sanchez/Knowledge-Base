...
- Highlights first synced by [[Readwise]] [[Monday, 31-10-2022]]
	- -
	- Import 'nodes.pp' $servidorpuppet = 'puppet.ejemplo.edu' #flashcard
	...
	- -
	- -
	- mode => 0440, source =>"puppet://$servidorpuppet/modules/sudo/etc/sudoers", require => Package["sudo"], } } #flashcard
		- CONTINUE
		- (Page 13)
	- -
	- -
	...
	- -
	- -
	- valores  por  defecto,  pero  hemos  querido  incluirlos  para  mostrar  las  opciones  más comunes de configuración a la hora de establecer un aprovisionamiento con Puppet. #flashcard
		- CONTINUE
		- (Page 22)
	- -
	- -
