...
- Highlights first synced by [[Readwise]] [[Thursday, 18-08-2022]]
	...
	- -
	- Bisección #car
	  id:: 6340151c-b1da-49fa-91c9-e6f4a883c04f
	...
	- -
	- -
	- Name Scalar and Structured types in Python. #car
	...
	- Do the tuples and strings in Python...
	  ...
	  * have the same sequence behaviour? #car
	...
	- -
	- Example of map() #car
	  id:: 6340151c-6b73-47a1-9548-5a388cd8a7a0
	...
	- -
	- -
	- Can you access a set by index? #car
	...
	- -
	- -
	- dict comprehension syntax #car
	  id:: 6340151c-1d5e-408e-98dd-35e9e2c02caf
	...
	- -
	- -
	- What is the difference between Testing and Debugging? #car
	...
	- -
	- -
	- Tip for unit tests #car
	  id:: 6340151c-fd26-4374-bb1c-e4e7062a6186
	...
	- -
	- -
	- Steps for white-box tests #car
	  id:: 6340151c-e8c5-46d7-8459-4752b40c67f5
	...
	- -
	- -
	- Usual cycle of tests in practice #car
	  id:: 6340151c-a600-4eeb-9556-56a4ca1becf5
	...
	- -
	- -
	- Why is Functional Testing harder #car
	...
	- -
	- -
	- Differences between 'Persistent' and 'Intermittent' Bugs #car
	...
	- -
	- -
	- Steps for debugging #car
	  id:: 6340151c-74cc-4b54-9162-b3b5ce85017a
	...
	- -
	- -
	- How to use the bisection search to better debugging #car
	...
	- -
	- -
	- Tip for a better approach in Testing #car
	...
	- -
	- -
	- What is an abstract data type? #car
	...
	- -
	- -
	- What is the purpose of an ADT? #car
	  id:: 6340151c-2b8d-488d-a41e-9e899580a66f
	...
	- -
	- -
	- Por esta razón hay que tener en cuenta el camino crítico #car
	  id:: 6340151c-6c31-43ed-9ca4-e445a13d4cfc
	...
	- -
	- About Big O #car
	  id:: 6340151c-0aae-4aad-847b-2ff2fcb32d21
