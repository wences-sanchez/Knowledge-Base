...
- Highlights first synced by [[Readwise]] [[Thursday, 18-08-2022]]
	...
	- -
	- -
	- Name Scalar and Structured types in Python. #card
	...
	- Do the tuples and strings in Python...
	  ...
	  * have the same sequence behaviour? #card
	...
	- -
	- -
	- Can you access a set by index? #card
	...
	- -
	- -
	- dict comprehension syntax #card
	...
	- -
	- -
	- What is the difference between Testing and Debugging? #card
	...
	- -
	- -
	- Steps for white-box tests #card
	...
	- -
	- -
	- Usual cycle of tests in practice #card
	...
	- -
	- -
	- Why is Functional Testing harder #card
	...
	- -
	- -
	- Difference between 'overt' and 'covert' bugs #card
	...
	- -
	- -
	- Differences between 'Persistent' and 'Intermittent' Bugs #card
	...
	- -
	- -
	- How to use the bisection search to better debugging #card
	...
	- -
	- -
	- Tip for a better approach in Testing #card
	...
	- -
	- -
	- What is an abstract data type? #card
	...
	- -
	- -
	- What is the purpose of an ADT? #card
	...
	- -
	- -
	- Por esta razón hay que tener en cuenta el camino crítico #card
