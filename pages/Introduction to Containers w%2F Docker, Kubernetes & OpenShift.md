	...
	- ### Understanding the Benefits of Containers
		...
		- #### Building Containerss Images
			- What is a Dockerfile?
				...
				- These are not interchangeable terms, but rather two distinct things. An image is an immutable file that contains the source code, libraries, and dependencies that are necessary for an application to run.
