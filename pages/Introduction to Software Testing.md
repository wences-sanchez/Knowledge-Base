	...
	- ### Lesson 1: Fundamental Testing Processes
		...
		- #### Importance of a Good Test Plan
			...
			- A test plan is useful to:
				...
				- Engineers are smart people. You're a smart person. We'll test something that we know needs to
				- happen even if it isn't explicit in those requirements.
				- This is an opportunity to go to the managers and
				- designers and expose a potential problem in the project.
				- The requirements are missing something
