...
- Highlights first synced by [[Readwise]] [[Thursday, 18-08-2022]]
	...
	- Stream.filter()
		- -
		- Which is the function to enter text in a web element? #card
	...
	- Stream.sort()
		- -
		- Example of lambda applied to Selenium #card
	...
	- Selenium WebDriver&#xA0;
		...
		- -
		- -
		- What is Selenium WebDriver? #card
	...
	- Setting up a project in Eclipse with Maven and TestNG using Java
		- -
		- What is (most basically) Selenium WebDriver? #card
		...
		- -
		- -
		- Name the best benefit of Maven. #card
		...
		- -
		- -
		- Mention the different eight ways of locating WebElements using By. #card
			- They are located by ID, Name, ClassName, TagName, LinkText, PartialLinkText, XPath, and CSS Selector.
		- -
		- -
		- What's related to a tag? #card
		...
		- -
		- -
		- Explain what the getText() method does. #card
		...
		- -
		- -
		- How can we get a stream in Java? #card
		...
		- -
		- -
		- Let's filter the stream obtained from the languages list to filter items starting with E #card
			- stream.filter( item -> item.startsWith("E") );
		- -
		- -
		- How can you order a stream? #card
			- languages.stream().sorted();
		- -
		- -
		- Let's take and convert the elements of languages list to uppercase (using streams) #card
			- languages.stream().map(item -> item.toUpperCase());
		- -
	- Stream.collect()
		- -
		- How can you retrieve the output of a stream operation? #card
	...
	- Stream.min() and Stream.max()
		- -
		- Calculate those names with the minimum price between a stream of objects which have ~.getPrice() #card
	...
	- Stream.count()
		- -
		- Count the number of objects which start with "MADISON" on a stream. #card
	...
	- Filtering element attributes
		- -
		- How could you get the images which have an empty alt attribute and store it in a list? #card
	...
	- Filtering and performing actions on WebElements
		- -
		- A way of retrieving the first WebElement using streams #card
	...
	- Taking screenshots
		- -
		- How many different formats has getScreenshotAs() #card
	...
	- Explicit wait time
		- -
		- Explicitly wait for one WebElement conditionally #card
			- WebElement searchBox = (new WebDriverWait(driver, 20))        .until((ExpectedCondition<WebElement>) d -> d.findElement(By.name("q")));
		- -
	- Implicit wait time
		- -
		- Implicit wait for the whole flow for remote executions #card
			- driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		- -
		- -
		- Questions of Chapter 3. #card
