...
- Highlights first synced by [[Readwise]] [[Monday, 31-10-2022]]
	...
	- -
	- -
	- A web server is no more than a piece of software running on a machine and listening to requests from a specific port. #flashcard
		- Recibiendo solicitudes por el protocolo HTTP
		- tags:: [[pink]] [[rosa]]
	...
	- -
	- -
	- $ php -S localhost:8000 #flashcard
		- El servidor web (en este caso el embebido) busca el fichero index.php primero
		- tags:: [[orange]] [[naranja]]
	...
	- -
	- -
	- $names[] = 'Neville'; #flashcard
		- Para hacer append del array
		- tags:: [[orange]] [[naranja]]
		- ([Location 1018](https://readwise.io/to_kindle?action=open&asin=B01ALMQ550&location=1018))
	- -
	- -
	- unset($status['status']); #flashcard
		- Para eliminar un elemento. 'status' es la clave a eliminar
		- tags:: [[orange]] [[naranja]]
	...
	- -
	- -
	- $containsHermione = in_array('Hermione', $names); #flashcard
		- e
		- tags:: [[orange]] [[naranja]]
