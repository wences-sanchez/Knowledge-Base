...
- Highlights first synced by [[Readwise]] [[Monday, 31-10-2022]]
	...
	- -
	- -
	- It is not necessary to explicitly declare properties within classes, as they can be implicitly defined when first used. #flashcard
		- Se puede llamar al constructor sin parámetros. Siempre y cuando no afecte a las variables internas de la clase. Cuando también está el constructor propio.
		- tags:: [[orange]] [[naranja]]
	...
	- -
	- sort #flashcard
		- Sort NO devuelve ningún array, es un procedimiento.
		- tags:: [[orange]] [[naranja]]
	...
	- -
	- explode #flashcard
		- Especificador de patrón separación como primer parámetro.
		- tags:: [[orange]] [[naranja]]
