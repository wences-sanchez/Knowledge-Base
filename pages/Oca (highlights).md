...
- Highlights first synced by [[Readwise]] [[Thursday, 18-08-2022]]
	- -
	- www.selikoff.net/oca. If there are any changes to the topics on the exam after this book is published, we will note them there. #space
	...
	- -
	- -
	- Together these are called the members of the class. #space
		- ([Location 1054](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=1054))
	- -
	- -
	- The public keyword on line 1 means the class can be used by other classes. #space
		- ([Location 1063](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=1063))
		- #[[pink]] #[[rosa]]
	- -
	- -
	- People often type an asterisk (*) at the beginning of each line of a multiline comment to make it easier to read, but you don't have to. #space
		- ([Location 1104](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=1104))
	- -
	- -
	- You can even put two classes in the same file. When you do so, at most one of the classes in the file is allowed to be public. #space
		- ([Location 1134](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=1134))
		- #[[blue]] #[[azul]]
	- -
	- -
	- If you do have a public class, it needs to match the filename. #space
		- ([Location 1138](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=1138))
		- #[[blue]] #[[azul]]
	- -
	- -
	- A main() method is the gateway between the startup of a Java process, which is managed by the Java Virtual Machine (JVM), and the beginning of the programmer's code. The JVM calls on the underlying system to allocate memory and CPU time, access files, and so on. #space
		- ([Location 1143](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=1143))
	- -
	- -
	- $ javac Zoo.java $ java Zoo #space
		- ([Location 1155](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=1155))
		- #[[orange]] #[[naranja]]
	- -
	- -
	- To compile Java code, the file must have the extension .java. The name of the file must match the name of the class. The result is a file of bytecode by the same name, but with a .class filename extension. #space
		- ([Location 1161](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=1161))
		- #[[blue]] #[[azul]]
	- -
	- -
	- Notice that we must omit the .class extension to run Zoo.java because the period has a reserved meaning in the JVM. #space
		- ([Location 1164](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=1164))
	- -
	- -
	- the JVM does this, #space
		- ([Location 1182](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=1182))
		- #[[blue]] #[[azul]]
	- -
	- -
	- If a main() method isn't present in the class we name with the .java executable, the process will throw an error and terminate. #space
		- ([Location 1182](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=1182))
	- -
	- -
	- Even if a main() method is present, Java will throw an exception if it isn't static. A nonstatic main() method might as well be invisible #space
		- ([Location 1184](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=1184))
		- #[[orange]] #[[naranja]]
	- -
	- -
	- it's good practice to use void for methods that change an object's state. In that sense, #space
		- ([Location 1188](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=1188))
	- -
	- -
	- you can write String[] args, String args[] or String… args; #space
		- ([Location 1193](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=1193))
		- #[[orange]] #[[naranja]]
	- -
	- -
	- The variable name args hints that this list contains values that were read in (arguments) when the JVM started. You can use any name you like, though. #space
		- ([Location 1194](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=1194))
		- #[[orange]] #[[naranja]]
	- -
	- -
	- The characters … are called varargs (variable argument lists). #space
		- ([Location 1197](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=1197))
	- -
	- -
	- args[0] accesses the first element of the array. #space
		- ([Location 1205](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=1205))
		- #[[blue]]
	- -
	- -
	- The output is what you might expect: #space
		- ([Location 1208](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=1208))
		- #[[blue]] #[[azul]]
	- -
	- -
	- you need to have a JDK to compile because it includes a compiler. You do not need to have a JDK to run the code—a JRE is enough. #space
		- ([Location 1230](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=1230))
		- #[[blue]] #[[azul]]
	- -
	- -
	- Java class files run on the JVM and therefore run on any machine with Java rather than just the machine or operating system #space
		- ([Location 1231](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=1231))
	- -
	- -
	- It doesn't import child packages, fields, or methods; it imports only classes. #space
		- ([Location 1282](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=1282))
		- #[[blue]] #[[azul]]
	- -
	- -
	- You might think that including so many classes slows down your program, but it doesn't. The compiler figures out what's actually needed. Which approach you choose is personal preference. #space
		- ([Location 1285](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=1285))
		- #[[pink]] #[[blue]] #[[azul]]
	- -
	- -
	- java.lang. This package is special in that it is automatically imported. #space
		- ([Location 1291](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=1291))
		- #[[pink]] #[[rosa]]
	- -
	- -
	- import java.nio.*; #space
	...
	- -
	- -
	- When counting instance initializers, keep in mind that it does matter whether the braces are inside a method. #space
		- ([Location 1508](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=1508))
		- #[[pink]] #[[rosa]]
	- -
	- -
	- The constructor runs after all fields and instance initializer blocks have run. #space
		- ([Location 1514](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=1514))
		- #[[pink]] #[[rosa]]
	- -
	- -
	- Fields and instance initializer blocks are run in the order in which they appear in the file. #space
		- ([Location 1514](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=1514))
		- #[[pink]] #[[rosa]]
	- -
	- -
	...
	- -
	- -
	- The today variable is a reference of type Date and can only point to a Date object. The greeting variable is a reference that can only point to a String object. #space
		- ([Location 1652](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=1652))
	- -
	- -
	- A value is assigned to a reference in one of two ways: A reference can be assigned to another object of the same type. A reference can be assigned to a new object using the new keyword. #space
		- ([Location 1656](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=1656))
		- #[[blue]] #[[azul]]
	- -
	- -
	- Primitive types will give you a compiler error if you attempt to assign them null. #space
		- ([Location 1675](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=1675))
		- #[[pink]] #[[rosa]]
	- -
	- -
	- String s3 = "yes", s4 = "no"; #space
		- ([Location 1710](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=1710))
		- #[[orange]] #[[naranja]]
	- -
	- -
	- That's the trick. Each snippet separated by a comma is a little declaration of its own. #space
		- ([Location 1724](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=1724))
		- #[[pink]] #[[rosa]]
	- -
	- -
	- The name must begin with a letter or the symbol $ or _. #space
		- ([Location 1759](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=1759))
		- #[[pink]] #[[rosa]]
	- -
	- -
	- Subsequent characters may also be numbers. #space
		- ([Location 1761](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=1761))
		- #[[pink]] #[[rosa]]
	- -
	- -
	- You cannot use the same name as a Java reserved word. #space
		- ([Location 1761](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=1761))
		- #[[pink]] #[[rosa]]
	- -
	- -
	- Until x is assigned a value, it cannot appear within an expression, #space
		- ([Location 1848](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=1848))
		- #[[blue]] #[[azul]]
	- -
	- -
	- The compiler knows there is the possibility for check to be false, resulting in uninitialized code, and gives a compiler error. #space
	...
	- -
	- -
	- two local variables in this method. bitesOfCheese is declared inside the method. piecesOfCheese is called a method parameter. #space
		- ([Location 1896](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=1896))
	- -
	- -
	- Class variables—in scope from declaration until program ends #space
		- ([Location 1980](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=1980))
		- #[[pink]] #[[rosa]]
	- -
	- -
	- Think of the acronym PIC (picture): package, import, and class. #space
	...
	- -
	- -
	- An object sits on the heap and does not have a name. Therefore, you have no way to access an object except through a reference. #space
		- ([Location 2051](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=2051))
	- -
	- -
	- It is the object that gets garbage collected, not its reference. #space
		- ([Location 2054](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=2054))
		- #[[blue]] #[[azul]]
	- -
	- -
	- finalize() for the exam. Just keep in mind that it might not get called and that it definitely won't be called twice. #space
		- ([Location 2099](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=2099))
	- -
	- -
	- Remember, finalize() is only run when the object is eligible for garbage collection. #space
	...
	- -
	- -
	- Java allows for functional programming within a class, but object oriented is still the main organization of code. #space
		- ([Location 2125](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=2125))
	- -
	- -
	- Java is an interpreted language because it gets compiled to bytecode. #space
		- ([Location 2128](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=2128))
	- -
	- -
	- “write once, run everywhere.” #space
		- ([Location 2130](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=2130))
		- #[[pink]]
	- -
	- -
	- When an object is instantiated, fields and blocks of code are initialized first. Then the constructor is run. #space
		- ([Location 2150](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=2150))
		- #[[blue]] #[[azul]]
	- -
	- -
	- There are three kinds of variables in Java, depending on their scope: instance variables, class variables, and local variables. #space
		- ([Location 2159](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=2159))
	- -
	- -
	- The finalize() method will run once for each object if/when it is first garbage collected. #space
		- ([Location 2165](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=2165))
		- #[[pink]] #[[rosa]]
	- -
	- -
	- Local variables require an explicit initialization; #space
		- ([Location 2179](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=2179))
		- #[[pink]] #[[rosa]]
	- -
	- -
	- Class variables remain in scope as long as the program is running. #space
	...
	- -
	- -
	- The best way to practice is to keep solving the review questions at the end of each chapter until you can read, understand, and answer them in under a minute. #space
