...
- Highlights first synced by [[Readwise]] [[Monday, 31-10-2022]]
	...
	- -
	- -
	- Sometimes code blocks are inside a method. These are run when the method is called. Other times, code blocks appear outside a method. These are called instance initializers. #flashcard
	...
	- -
	- -
	- Fields and blocks are run first in order, setting number to 3 and then 4. Then the constructor runs, setting number to 5. #flashcard
		- ¡El constructor es lo último que se ejecuta!
		- tags:: [[pink]] [[rosa]]
	...
	- -
	- -
	- double notByDecimal = 1000_.00; #flashcard
	...
	- -
	- -
	- Instance and class variables do not require you to initialize them. As soon as you declare these variables, they are given a default value. #flashcard
	...
	- -
	- -
	- A file is also allowed to have neither class be public. #flashcard
		- ¡PROBAR EN PC!
		- ([Location 2024](https://readwise.io/to_kindle?action=open&asin=B00R04DF3I&location=2024))
	- -
	- -
	- An object will remain on the heap until it is no longer reachable. An object is no longer reachable when one of two situations occurs: The object no longer has any references pointing to it. All references to the object have gone out of scope. #flashcard
	...
	- -
	- -
	- finalize() call could run zero or one time. #flashcard
