...
- Highlights first synced by [[Readwise]] [[Monday, 31-10-2022]]
	...
	- 11 TESTING YOUR CODE
		...
		- -
		- -
		- print(bicycles[-1]) #flashcard
			- Show the last item of the list bicycles.
		- -
		- -
		- popped_motorcycle = motorcycles.pop()
		  ➌ print(motorcycles)
		  ➍ print(popped_motorcycle) #flashcard
			- Remove the last item of the list motorcycles, 
			  then show the resultant list, 
			  then show the removed object
			  [call it removed_item]
		- -
		- -
		- first_owned = motorcycles.pop(0) #flashcard
			- Save in a variable named first_owned the (just removed) element with index 0 of the list motorcycles
		- -
		- -
		- To write a test case for a function, import the unittest module and the function you want to test. Then create a class that inherits from unittest.TestCase, and write a series of methods to test #flashcard
			- Steps to create tests in Python
		- -
		- -
	...
	- 9 CLASSES
		- -
		- Any method that starts with test_ will be run automatically when we run test_name_function.py. #flashcard
			- How do we call a testing function?
		- -
		- -
		- message = f"My first bicycle was a {bicycles[0].title()}." #flashcard
			- Show a variable named status inside a string (in Python 3)
		- -
		- -
		- motorcycles.remove('ducati') #flashcard
			- 'Steal' the element with value 'ducati' from the motorcycles list
		- -
		- -
		...
		- -
		- -
		- motorcycles.append('ducati') #flashcard
			- Add 'ducati' at the end of the list motorcycles
		- -
		- -
		- motorcycles.remove(too_expensive) #flashcard
			- 'Steal' the element with content 'ducati' from the motorcycles list.
			  [Use the already defined variable named my_brand for this task]
		- -
		- -
		- len(cars) #flashcard
			- Function to get the size of the list cars
		- -
		- -
		- def __init__(self, make, model, year):
		           """Initialize attributes of the parent class."""
		  ➍         super().__init__(make, model, year) #flashcard
			- How would you define a constructor of a child class in Python?
		- -
		- -
		- A method is an action that Python can perform on a piece of data. #flashcard
		- -
		- -
		- bicycles = ['trek', 'cannondale', 'redline', 'specialized'] #flashcard
		...
		- -
		- -
		- print(bicycles[0]) #flashcard
			- Show the first element of the list bicycles.
		- -
		- -
		- motorcycles.insert(0, 'ducati') #flashcard
			- Insert 'ducati' at the beginning of the list motorcycles without using square brackets:
		- -
		- -
		- cars.sort() #flashcard
			- Order alphabetically a list named cars. Make this change permanent.
		- -
		- -
		...
		- -
		- -
		- del motorcycles[0] #flashcard
			- Remove the first element of the list motorcycles
		- -
		- -
		- cars.sort(reverse=True) #flashcard
			- Order alphabetically inversed a list named cars. Make this change permanent.
		- -
		- -
		...
		- -
		- -
		- print(sorted(cars)) #flashcard
			- Show an alphabetically ordered list named cars. Make this change temporal.
		- -
		- -
		...
		- -
		- -
		- cars.reverse() #flashcard
			- Make the order of the list cars inverse.
		- -
		- -
		- Although you can't modify a tuple, you can assign a new value to a variable that represents a tuple. #flashcard
			- Is it possible to reassign a tuple's content?
		- -
		- -
		...
		- for value in range(1, 5):
		    print(value) #flashcard
			- Show the numbers: [1, 4]
		- -
		- -
		...
		- -
		- -
		- print(players[0:3]) #flashcard
			- Show in a slice the first three items of the list players.
		- -
		- -
		- friend_foods = my_foods[:] #flashcard
			- Copy the list my_foods to the list friend_foods without affectations.
		- -
		- -
		- Remember that each time you use pop(), the item you work with is no longer stored in the list. #flashcard
		- -
		- -
		- squares = [value**2 for value in range(1, 11)] #flashcard
			- [List Comprehension]
			  Begin with a descriptive name for the list, such as squares. Next, open a set of square brackets and define the expression for the values you want to store in the new list. In this example the expression is value**2, which raises the value to the second power. Then, write a for loop to generate the numbers you want to feed into the expression, and close the square brackets. The for loop in this example is for value in range [1, 10]
		- -
		- -
		- print(players[1:4]) #flashcard
			- Show in a slice the second, third and fourth items of the list players
		- -
		- -
		- alphabetically #flashcard
		- -
		- -
		- numbers = list(range(1, 6)) #flashcard
			- Construct a list with the numbers: [1, 5]
		- -
		- -
		- Notice that reverse() doesn’t sort backward alphabetically; it simply reverses the order of the list: #flashcard
		- -
		- -
		- For dictionaries, specifically, you can use the get() method to set a default value that will be returned if the requested key doesn’t exist. #flashcard
			- Another way of access to an element in a dict instead of indexes in square brackets
		- -
		- -
		...
		- print(f"You ordered a {pizza['crust']}-crust pizza "
		       "with the following toppings:") #flashcard
			- How can you split a string in multiple lines?
		- -
		- -
	...
	- 6 DICTIONARIES
		...
		- -
		- -
		- alien_0 = {'color': 'green', 'points': 5} #flashcard
	...
	- 8 FUNCTIONS
		...
		- -
		- -
		- The best approach is to import the function or functions you want, or import the entire module and use the dot notation. This leads to clear code that's easy to read and understand. #flashcard
			- How should I use the import's in Python?
		- -
	- 10 FILES AND EXCEPTIONS
		...
		- ➊ alien_0['x_position'] = 0
		  ➋ alien_0['y_position'] = 25 #flashcard
		...
		- -
		- -
		- del alien_0['points'] #flashcard
			- Remove the entry with key ‘points’ from the dict alien.
		- -
		- -
		- point_value = alien_0.get('points', 'No point value assigned.') #flashcard
		...
		- -
		- -
		- for key, value in user_0.items(): #flashcard
			- Loop over dict user_0 with its separate parts
		- -
		- -
		- for name in favorite_languages.keys():
		       print(name.title()) #flashcard
			- Iterate over the keys of a dict fav_langs {name:value}
		- -
		- -
		- The keys() method isn’t just for looping: it actually returns a list of all the keys, and the line at ➊ simply checks if 'erin' is in this list. #flashcard
			- Tell another use of keys() in Python aside looping
		- -
		- -
		- for language in favorite_languages.values(): #flashcard
			- Iterate over the content of a dict fav_langs on a loop {key: content}
		- -
		- -
		- for language in set(favorite_languages.values()): #flashcard
			- Iterate over the content of a dict without repeating.
			  Dict: fav_langs
		- -
		- -
		- for alien_number in range(30): #flashcard
			- Repeat a message ‘me’ 30 times in Python.
		- -
		- -
		- The function describe_pet() hasn’t changed. But when we call the function, we explicitly tell Python which parameter each argument should be matched with. When Python reads the function call, it knows to assign the argument 'hamster' to the parameter animal_type and the argument 'harry' to pet_name. The output correctly shows that we have a hamster named Harry.
		  ...
		  The order of keyword arguments doesn’t matter because Python knows where each value should go. #flashcard
		...
		- -
		- -
		- print_models(unprinted_designs[:], completed_models) #flashcard
			- Print via a function in Python a list without being able to modify it.
		- -
		- -
		- def make_pizza(*toppings):
		    """Print the list of toppings that have been requested."""
		    print(toppings) #flashcard
			- Design a function which contains unlimited arguments.
		- -
		- -
		- The asterisk in the parameter name *toppings tells Python to make an empty tuple called toppings and pack whatever values it receives into this tuple. The print() call in the function body produces output showing that Python can handle a function call with one value and a call with three values. It treats the different calls similarly. Note that Python packs the arguments into a tuple, even if the function receives only one value #flashcard
			- Explain how unlimited function parameters works in Python
		- -
		- -
		- def build_profile(first, last, **user_info):
		  ...
		       return user_info #flashcard
			- Can you pass infinite key-value entries to a function in Python?
		- -
		- -
		- import pizza #flashcard
			- Bring the module ‘pizza’ into your scope to use pizza.make_pizza()
		- -
		- -
		- from pizza import make_pizza #flashcard
			- Bring the module ‘pizza’ into your scope to use ONLY pizza.make_pizza().
			  
			  Use it.
		- -
		- -
		- from pizza import make_pizza as mp #flashcard
			- Bring the module ‘pizza’ into your scope to use ONLY pizza.make_pizza(). Use an alias.
			  
			  Use it.
		- -
		- -
		- import pizza as p #flashcard
		...
		- def __init__(self, name, age):
		  ...
		  ➍         self.name = name
		           self.age = age #flashcard
			- Build a constructor in Python
		- -
		- -
		- def sit(self):
		           """Simulate a dog sitting in response to a command."""
		           print(f"{self.name} is now sitting.") #flashcard
			- Define a method in Python
		- -
		- -
		- my_dog = Dog('Willie', 6) #flashcard
		...
		- def __init__(self, make, model, year):
		           """Initialize attributes of the parent class."""
		  ➍         super().__init__(make, model, year) #flashcard
			- How do you call a base class' constructor from the subclass?
		- -
		- -
		- with open('pi_digits.txt') as file_object:
		    contents = file_object.read()
		  print(contents) #flashcard
			- How do you read a text file?
		- -
		- -
		- Notice how we call open() in this program but not close(). You could open and close the file by calling open() and close(), but if a bug in your program prevents the close() method from being executed, the file may never close. This may seem trivial, but improperly closed files can cause data to be lost or corrupted. And if you call close() too early in your program, you’ll find yourself trying to work with a closed file (a file you can’t access), which leads to more errors. It’s not always easy to know exactly when you should close a file, but with the structure shown here, Python will figure that out for you. All you have to do is open the file and work with it as desired, trusting that Python will close it automatically when the with block finishes execution. #flashcard
			- Should I close a file in Python or not?
		- -
		- -
		- Windows systems use a backslash (\) instead of a forward slash (/) when displaying file paths, but you can still use forward slashes in your code. #flashcard
			- Forward slashes OR backslashes in Python?
		- -
		- -
		...
		- filename = 'programming.txt'
		  ...
		  ➋     file_object.write("I love programming.") #flashcard
			- Write some text in a file in Python.
		- -
		- -
		- You can open a file in read mode ('r'), write mode ('w'), append mode ('a'), or a mode that allows you to read and write to the file ('r+'). If you omit the mode argument, Python opens the file in read-only mode by default. #flashcard
			- Different file modes in Python.
		- -
		- -
		- Any code that depends on the try block succeeding is added to the else block. In this case if the division operation is successful, we use the else block to print the result #flashcard
			- What does ‘else’ mean in a Exception?
		- -
		- -
		- try:
