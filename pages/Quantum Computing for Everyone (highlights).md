...
- Highlights first synced by [[Readwise]] [[Thursday, 18-08-2022]]
	...
	- The first measure is whatever. But the second has to be random when we compare it with the first (exactly 1/2).
	  ...
	  But if we measure once, the result is definite. #card
	...
	- -
	- -
	- How Quantum and traditional computing are related #card
	...
	- -
	- -
	- Qubits are random but unique. #card
	...
	- -
	- -
	- About being sure of (specific) Quantum measurements #card
	...
	- -
	- -
	- Quantum Computing for everyone #card
