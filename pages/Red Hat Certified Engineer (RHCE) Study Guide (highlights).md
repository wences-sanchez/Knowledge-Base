...
- Highlights first synced by [[Readwise]] [[Thursday, 01-09-2022]]
	...
	- 2. Working with the Ansible Configuration
		...
		- How do you see the Ansible full config? #flashcard
			...
			- **ansible-config view** muestra el fichero que tenemos
			- **ansible-config dump** lo muestra todo (los *por defecto* y los seteados)
			- Y **ansible-config list** muestra todo con todas las explicaciones (verbose)
		- -
		- -
