...
- Highlights first synced by [[Readwise]] [[Thursday, 18-08-2022]]
	- -
	- ¿De qué se encarga la capa de red? #car
	  id:: 63401533-9e65-4588-bb8d-f48c4d8cf234
	...
	- -
	- -
	- El direccionamiento en red, ¿en qué está basado? #car
	...
	- -
	- -
	- ¿Dónde se configura la dirección de red? #car
	  id:: 63401533-dea3-4a90-bc6f-b42f242d7851
	...
	- -
	- -
	- ¿Qué cuatro direccionamientos de red existen? #car
	  id:: 63401533-321d-4005-b3cb-e4b02bc81d6e
	...
	- -
	- -
	- ¿Cómo es el enrutamiento unicast? +++ #car
	...
	- -
	- -
	- ¿Cómo es el enrutamiento broadcast? +++ #car
	  id:: 63401533-af7c-4ab4-96da-ad2bfc5e66fe
	...
	- -
	- -
	- ¿Cómo es el enutamiento boadcast? #car
	  id:: 63401533-de73-446a-ba3a-c47518a1d8a5
		- r
		- (Page 11)
	- -
	- -
	- ¿Cómo es el enrutamiento multicast? +++ #car
	...
	- -
	- -
	- ¿Cómo es el enrutamiento anycast? +++ #car
	...
	- -
	- -
	- ¿Cómo funciona el algoritmo de enrutamiento del camino más corto? #car
	...
	- -
	- -
	- ¿Cómo funciona el algoritmo de enrutamiento de flooding? #car
	...
	- -
	- -
	- ¿Cómo funciona el algoritmo de enrutamiento de vectores de distancia? +++ #car
	  id:: 63401533-45a3-4bc3-9f71-08932ab76ac3
	...
	- -
	- -
	- ¿Cómo funciona el algoritmo de enrutamiento de estado de enlace? #car
	...
	- -
	- -
	- ¿En qué consiste el tunneling? +++ #car
	  id:: 63401533-182f-46b0-a16e-c6cf5f1d43db
	...
	- -
	- -
	- ¿Cómo se define una dirección MAC y cómo puede ser encontrada? #car
	  id:: 63401533-352b-4202-84f2-0e2aa2a1b024
	...
	- -
	- -
	- ¿Cómo es mapeada la dirección MAC a la IP? #car
	...
	- -
	- -
	- ¿Qué protocolo es el que usamos cuando hacemos 'ping' en un SO? #car
	...
	- -
	- -
	- ¿Cómo podemos expresar un prefijo de red de 16 bits en una dirección IP? #car
	...
	- -
	- +++ #car
	  id:: 63401533-7f38-491d-84a7-9a279819778b
	...
	- -
	- -
	- ¿Por qué es negativo jerarquizar las direcciones IP? #car
	...
	- -
	- -
	- ¿Cuáles son las tres categorías de direcciones IP, teniendo en cuenta sus subredes? +++ #car
	...
	- -
	- ¿Qué es el CIDR? #car
	  id:: 63401533-b5d4-46de-8f5a-d49a75df6f6d
	...
	- -
	- -
	- ¿Qué es TCP y cuáles son sus principales características? #car
	  id:: 63401533-4da2-4ca3-af01-4bcb2029fd52
	...
	- -
	- -
	- ¿Cómo se establece la conexión entre un cliente y un servidor con ACKs? +++ #car
	  id:: 63401533-580b-4dc8-b595-fa548db7916d
	...
	- -
	- +++ #car
	  id:: 63401533-14b6-4402-9da7-6c44ef134aa3
	...
	- -
	- -
	- ¿Qué se conoce como UDP? #car
	  id:: 63401533-fcf4-49a6-81ce-368d8d1e5231
