...
- Highlights first synced by [[Readwise]] [[Thursday, 18-08-2022]]
	- -
	- ¿De qué se encarga la capa de red? #card
	...
	- -
	- -
	- El direccionamiento en red, ¿en qué está basado? #card
	...
	- -
	- -
	- ¿Dónde se configura la dirección de red? #card
	...
	- -
	- -
	- ¿Qué cuatro direccionamientos de red existen? #card
	...
	- -
	- -
	- ¿Cómo es el enrutamiento unicast? +++ #card
	...
	- -
	- -
	- ¿Cómo es el enrutamiento broadcast? +++ #card
	...
	- -
	- -
	- ¿Cómo es el enutamiento boadcast? #card
		- r
		- (Page 11)
	- -
	- -
	- ¿Cómo es el enrutamiento multicast? +++ #card
	...
	- -
	- -
	- ¿Cómo es el enrutamiento anycast? +++ #card
	...
	- -
	- -
	- ¿Cómo funciona el algoritmo de enrutamiento del camino más corto? #card
	...
	- -
	- -
	- ¿Cómo funciona el algoritmo de enrutamiento de flooding? #card
	...
	- -
	- -
	- ¿Cómo funciona el algoritmo de enrutamiento de vectores de distancia? +++ #card
	...
	- -
	- -
	- ¿Cómo funciona el algoritmo de enrutamiento de estado de enlace? #card
	...
	- -
	- -
	- ¿En qué consiste el tunneling? +++ #card
	...
	- -
	- -
	- ¿Cómo se define una dirección MAC y cómo puede ser encontrada? #card
	...
	- -
	- -
	- ¿Cómo es mapeada la dirección MAC a la IP? #card
	...
	- -
	- -
	- ¿Qué protocolo es el que usamos cuando hacemos 'ping' en un SO? #card
	...
	- -
	- -
	- ¿Cómo podemos expresar un prefijo de red de 16 bits en una dirección IP? #card
	...
	- -
	- -
	- ¿Por qué es negativo jerarquizar las direcciones IP? #card
	...
	- -
	- -
	- ¿Cuáles son las tres categorías de direcciones IP, teniendo en cuenta sus subredes? +++ #card
	...
	- -
	- -
	- ¿Qué es TCP y cuáles son sus principales características? #card
	...
	- -
	- -
	- ¿Cómo se establece la conexión entre un cliente y un servidor con ACKs? +++ #card
