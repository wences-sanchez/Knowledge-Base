...
- Highlights first synced by [[Readwise]] [[Thursday, 18-08-2022]]
	...
	- 2. Getting Started with Terraform
		...
		- -
		- -
		- The three (optional) parts of a variable’s declaration body. #card
	...
	- A. Recommended Reading
		- -
		- Which files and/or directories should I put in the .gitignore when using Terraform? #card
		...
		- -
		- -
		- Example of a variable declaration. #card
		...
		- -
		- -
		- What does provisioning mean? #card
		...
		- -
		- -
		- How can you use a reference of an attribute in Terraform? #card
		...
		- -
		- -
		- What is a data source in Terraform? #card
		...
		- -
		- -
		- About referring to the documentation of Terraform. #card
		...
		- -
		- -
		- Example of data source declaration in Terraform. #card
