file:: [Azure_Modulo-3_Soluciones-principales-de-Azure_1668072076275_0.pdf](../assets/Azure_Modulo-3_Soluciones-principales-de-Azure_1668072076275_0.pdf)
...
- ## Tema 2: Herramientas de administración de Azure
	...
	- ### 2.7 Plantillas de Azure Resource Manager (ARM)
		- Las **plantillas de Azure Resource Manager (ARM)** son archivos JSON (JavaScript Object Notation) que se pueden usar para crear e implementar la infraestructura de Azure sin tener que escribir comandos de programación. 
		  ...
		  hl-color:: yellow
		  Las características y ventajas del uso de estas plantillas son: #flashcard
